...
const invalidNewWithInvalidIpfsCid =
  "osn:q:1:N:N:1:bafybeigvbkfmhdgnqko4ev35wfecx7exiyg35gcr7rh45ywlpw2v62ityp";
...
describe("Spec parser", () => {
  test("parse valid new interaction works", () => {
    ...
    expect(interaction.topicIpfsCid).toBe(
  ...
  test("parse valid append interaction works", () => {
    ...
    expect(interaction.messageIpfsCid).toBe(
  ...
  test("parse valid answer interaction works", () => {
    ...
    expect(interaction.answerIpfsCid).toBe(
  ...
  test("parse valid fund interaction works", () => {
    ...
    expect(interaction.ipfsCid).toBe(
      "bafybeibknoqig3k472ke56llloupmlf7g6u6xwxntje4pm2a37npb343n4"
    );
  });
